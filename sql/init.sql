...
CREATE TABLE t_product (
    ...
    status              TINYINT DEFAULT 1 COMMENT '0-offline 1-online 2-seckill',
...
('iPhone 16 Pro', 'Apple flagship smartphone for flash-sale demos', 8999.00, 2, 6999.00, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY)),
('MacBook Pro M4', 'High-performance laptop for demo inventory and order flows', 14999.00, 2, 11999.00, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY)),
('AirPods Pro 3', 'Wireless earbuds used as a lightweight sample product', 1899.00, 2, 1299.00, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY));
...
CREATE TABLE t_order (
    id           BIGINT PRIMARY KEY COMMENT 'Snowflake order ID',
    user_id      BIGINT NOT NULL,
    product_id   BIGINT NOT NULL,
    product_name VARCHAR(200),
    order_price  DECIMAL(10,2),
    quantity     INT DEFAULT 1,
    status       TINYINT DEFAULT 0 COMMENT '0-unpaid 1-paid 2-cancelled 3-timeout',
    pay_time     DATETIME,
    create_time  DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time  DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
